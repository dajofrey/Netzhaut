...
static nh_x11_Property nh_x11_readProperty(
...
NH_API_RESULT nh_wsi_createMacOSWindow(
    nh_macos_Window *Window_p, nh_wsi_WindowConfig Config, nh_gfx_SurfaceRequirements *Requirements_p) 
{
    @autoreleasepool {
        ...
        // Create a structure to hold the window handle
        nh_macos_Window *Window_p = (nh_macos_Window*)malloc(sizeof(nh_macos_Window));
        Window_p->Handle = window;
        return Window_p;
    }
}
