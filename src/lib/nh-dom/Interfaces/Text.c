    ...
    nh_webidl_DOMString Data, nh_webidl_Object *NodeDocument_p)
{
    ...
    NH_CORE_CHECK_2(NULL, nh_dom_appendToCharacterData((nh_webidl_Object*)Text_p->Parent_p, Data))

    return (nh_webidl_Object*)Text_p;
}
    ...
    nh_webidl_Object *Text_p, nh_webidl_DOMString DOMString)
{
    NH_CORE_CHECK(nh_dom_appendToCharacterData(
        (nh_webidl_Object*)((nh_webidl_Object*)Text_p)->Parent_p, DOMString))
...
{
    return nh_dom_getCharacterDataString((nh_webidl_Object*)((nh_webidl_Object*)Text_p)->Parent_p);
}
