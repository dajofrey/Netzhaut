...
//
//    if (NH_LOADER.load_f("nhecmascript", 0) == NH_CORE_SUCCESS) 
//    {
//        nh_core_activateWorkload(
//            (nh_ecmascript_initAgent_f)NH_LOADER.loadSymbol_f("nhecmascript", 0, "nh_ecmascript_initAgent"), 
//            (nh_ecmascript_runAgent_f)NH_LOADER.loadSymbol_f("nhecmascript", 0, "nh_ecmascript_runAgent"), 
//            &Args, NH_FALSE
//        );
//    }
