...
NH_API_RESULT nh_api_appendUTF32(
    nh_encoding_UTF32String *String_p, NH_ENCODING_UTF32 *codepoints_p, unsigned long length)
{
    ...
    return appendUTF32_f ? appendUTF32_f(String_p, codepoints_p, length) : NH_API_ERROR_BAD_STATE;
}
    ...
    nh_encoding_UTF32String *String_p)
{
    ...
    return freeUTF32_f ? freeUTF32_f(String_p) : NH_API_ERROR_BAD_STATE;
}
