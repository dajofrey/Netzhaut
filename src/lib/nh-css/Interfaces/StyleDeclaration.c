...
nh_ecmascript_Object *nh_css_createStyleDeclaration(
    nh_core_Array Declarations)
{
    nh_ecmascript_Object *StyleDeclaration_p = nh_webidl_createObject("CSS", "CSSStyleDeclaration");
...
nh_core_Array *nh_css_getStyleDeclarationData(
    nh_ecmascript_Object *CSSStyleDeclaration_p)
{
