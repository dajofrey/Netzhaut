...
if [ "$1" = "clean" ]; then
    rm -f src/lib/nh-encoding/Base/UnicodeData.gen.c
    rm -f src/lib/nh-encoding/Base/UnicodeData.gen.h
else
    # License Notice
    LICENSE_NOTICE="\
    /**\n\
    ...
    c_file="src/lib/nh-encoding/Base/UnicodeData.gen.c"
    h_file="src/lib/nh-encoding/Base/UnicodeData.gen.h"
