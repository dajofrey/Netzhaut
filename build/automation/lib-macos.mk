...
LIB_NH_API = lib/libnh-api.dylib
LIB_NH_CORE = lib/libnh-core.dylib
LIB_NH_WSI = lib/libnh-wsi.dylib
LIB_NH_HTML = lib/libnh-html.dylib
LIB_NH_DOM = lib/libnh-dom.dylib
LIB_NH_NETWORK = lib/libnh-network.dylib
LIB_NH_WEBIDL = lib/libnh-webidl.dylib
LIB_NH_ECMASCRIPT = lib/libnh-ecmascript.dylib
LIB_NH_ENCODING = lib/libnh-encoding.dylib
LIB_NH_GFX = lib/libnh-gfx.dylib
LIB_NH_RENDERER = lib/libnh-renderer.dylib
LIB_NH_CSS = lib/libnh-css.dylib
LIB_NH_URL = lib/libnh-url.dylib
LIB_NH_MONITOR = lib/libnh-monitor.dylib
...
$(LIB_NH_API): create_lib_dir $(OBJ_FILES_NH_API)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-api.dylib) $(OBJ_FILES_NH_API) $(LINKER_FLAGS_NH_API)
$(LIB_NH_CORE): create_lib_dir $(OBJ_FILES_NH_CORE)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-core.dylib) $(OBJ_FILES_NH_CORE) $(LINKER_FLAGS_NH_CORE)
$(LIB_NH_WSI): create_lib_dir $(OBJ_FILES_NH_WSI)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-wsi.dylib) $(OBJ_FILES_NH_WSI) $(LINKER_FLAGS_NH_WSI)
$(LIB_NH_HTML): create_lib_dir $(OBJ_FILES_NH_HTML)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-html.dylib) $(OBJ_FILES_NH_HTML) $(LINKER_FLAGS_NH_HTML)
$(LIB_NH_DOM): create_lib_dir $(OBJ_FILES_NH_DOM)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-dom.dylib) $(OBJ_FILES_NH_DOM) $(LINKER_FLAGS_NH_DOM)
$(LIB_NH_NETWORK): create_lib_dir $(OBJ_FILES_NH_NETWORK)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-network.dylib) $(OBJ_FILES_NH_NETWORK) $(LINKER_FLAGS_NH_NETWORK)
$(LIB_NH_WEBIDL): create_lib_dir $(OBJ_FILES_NH_WEBIDL)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-webidl.dylib) $(OBJ_FILES_NH_WEBIDL) $(LINKER_FLAGS_NH_WEBIDL)
$(LIB_NH_ECMASCRIPT): create_lib_dir $(OBJ_FILES_NH_ECMASCRIPT)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-ecmascript.dylib) $(OBJ_FILES_NH_ECMASCRIPT) $(LINKER_FLAGS_NH_ECMASCRIPT)
$(LIB_NH_ENCODING): create_lib_dir $(OBJ_FILES_NH_ENCODING)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-encoding.dylib) $(OBJ_FILES_NH_ENCODING) $(LINKER_FLAGS_NH_ENCODING)
$(LIB_NH_GFX): create_lib_dir $(OBJ_FILES_NH_GFX)
	$(LINKER) $(CFLAGS) -Wl,-rpath,'$(CURDIR)/external/freetype-gl' -shared -o $@ $(call INSTALL_NAME,libnh-gfx.dylib) $(OBJ_FILES_NH_GFX) $(LINKER_FLAGS_NH_GFX)
$(LIB_NH_RENDERER): create_lib_dir $(OBJ_FILES_NH_RENDERER)
	$(LINKER) $(CFLAGS) -shared -o $@ $(call INSTALL_NAME,libnh-renderer.dylib) $(OBJ_FILES_NH_RENDERER) $(LINKER_FLAGS_NH_RENDERER)
