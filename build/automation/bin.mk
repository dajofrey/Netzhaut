...
CC = gcc
CFLAGS = -g -std=gnu99 -Wl,-rpath,$(CURDIR)/lib,-rpath,$(CURDIR)/external/Termoskanne/lib

# Define the linker and linker flags
LD = gcc
LDFLAGS_NH_HTML = -Llib -lnh-api
LDFLAGS_NH_CSS = -Llib -lnh-api
LDFLAGS_NH_MONITOR = -Llib -lnh-api -Lexternal/Termoskanne/lib -ltk-api
LDFLAGS_NH_ECMASCRIPT = -Llib -lnh-api
LDFLAGS_NH_WSI = -Llib -lnh-api
LDFLAGS_NH_WEBIDL = -Llib -lnh-api
...
SRC_DIR_NH_WSI = src/bin/nh-wsi
SRC_DIR_NH_WEBIDL = src/bin/nh-webidl
...
SRC_FILES_NH_WSI = Main.c
SRC_FILES_NH_WEBIDL = Main.c
...
$(OBJ_FILES_NH_MONITOR): CFLAGS += $(CCFLAGS) -Iexternal/Termoskanne/src/lib -Isrc/lib -Iexternal
$(OBJ_FILES_NH_ECMASCRIPT): CFLAGS += $(CCFLAGS) -Isrc/lib -Iexternal
$(OBJ_FILES_NH_WSI): CFLAGS += $(CCFLAGS) -Isrc/lib -Iexternal
$(OBJ_FILES_NH_WEBIDL): CFLAGS += $(CCFLAGS) -Isrc/lib -Iexternal
...
$(BIN_NH_MONITOR): create_bin_dir build_termoskanne $(OBJ_FILES_NH_MONITOR)
...
$(BIN_NH_WSI): create_bin_dir $(OBJ_FILES_NH_WSI)
	$(LD) $(CFLAGS) -o $@ $(OBJ_FILES_NH_WSI) $(LDFLAGS_NH_WSI)
$(BIN_NH_WEBIDL): create_bin_dir $(OBJ_FILES_NH_WEBIDL)
	$(LD) $(CFLAGS) -o $@ $(OBJ_FILES_NH_WEBIDL) $(LDFLAGS_NH_WEBIDL)
