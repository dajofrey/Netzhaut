...
NH_BEGIN()
    ...
    if (strstr(path_p, ".jpg") || strstr(path_p, ".jpeg")) {NH_END(NH_MEDIA_IMAGE_JPEG)}
    if (strstr(path_p, ".png")) {NH_END(NH_MEDIA_IMAGE_PNG)}
    if (strstr(path_p, ".ktx")) {NH_END(NH_MEDIA_IMAGE_KTX)}
    if (strstr(path_p, ".dds")) {NH_END(NH_MEDIA_IMAGE_DDS)}

    if (strstr(path_p, ".ttf")) {NH_END(NH_MEDIA_FONT_TTF)}
    if (strstr(path_p, ".otf")) {NH_END(NH_MEDIA_FONT_OTF)}

    if (strstr(path_p, ".htm")) {NH_END(NH_MEDIA_TEXT_HTML)}
    if (strstr(path_p, ".css")) {NH_END(NH_MEDIA_TEXT_CSS)}
    if (strstr(path_p, ".js"))  {NH_END(NH_MEDIA_TEXT_JAVASCRIPT)}
